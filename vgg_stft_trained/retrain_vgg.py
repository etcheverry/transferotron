...
checkpointer = ModelCheckpoint("./models/vgg_sound_trained.h5", monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=True, mode='auto', period=1)
